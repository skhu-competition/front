...
const Login = () => {
  ...
  const googleLoginClick = () => {
    const googleLoginUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=386024538579-h9a29u0v67h2982jbfmp9ob1n4t98c5h.apps.googleusercontent.com&redirect_uri=http://localhost:8080/auth/google/login&response_type=code&scope=profile email`;
