...
import logo from './assets/skhu-icon.svg';
  ...
  return (
    <div className="login-container">
      ...
      >
        ...
        <button className='google-login-button'><img src={googleLogo} alt='googleLogo' className='google-logo'/> Google 계정으로 계속하기</button>
      </motion.div>
    </div>
  );
};
